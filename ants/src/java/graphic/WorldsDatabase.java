...
public class WorldsDatabase
{
	 ...
	 * @param world Reference to the world
	 */
	private static void world1(World world)
	{	
		world.setWidth(1000);
		world.setHeight(600);
	 ...
	 * @param world Reference to the world
	 */
	private static void world2(World world)
	{	
		world.setWidth(1000);
		world.setHeight(600);
	 ...
	 * @param world Reference to the world
	 */
	private static void world3(World world)
	{	
	 ...
	 */
	private static void worldResourceExperiment1(World world)
	{
		world.setHeight(600);
		world.setWidth(1000);
	 ...
	 * @param world Reference to the world
	 */
	private static void worldResourceExperiment2(World world)
	{
	 ...
	 * @param world Reference to the world
	 */
	private static void worldResourceExperiment3(World world)
	{
	 ...
	 * @param world Reference to the world
	 */
	private static void worldDeathMatch(World world)
	{	
		world.setWidth(1000);
		world.setHeight(600);
	 ...
	 * @param world Reference to the world
	 */
	private static void randomWorld(World world)
	{
